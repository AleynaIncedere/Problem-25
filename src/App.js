...
export default function LandingPage() {
  ...
  const [isClicked, setIsClicked] = useState(false) // Buton tıklama durumu için state

  function goToPricing() {
    pricingRef.current.scrollIntoView({ behavior: 'smooth' })
    setIsClicked(true) // "Fiyatlandırmaya gidin" butonuna tıklanınca state değişiyor
  }
          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl text-center'>
              ...
              <div className='mt-10 flex items-center justify-center'>
                <button
                  onClick={goToPricing}
                  className='rounded-md px-4 py-3 text-base font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 bg-indigo-600 hover:bg-indigo-500'
                >
            ...
            <div className='flex flex-col justify-center rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 lg:z-10 lg:rounded-b-none'>
              ...
              <a
                ...
                className={`mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 
                  ${isClicked ? 'bg-red-600 hover:bg-red-700' : 'bg-indigo-600 hover:bg-indigo-500'} 
